...
import { queppelinAbi, queppelinCoinAddress} from '../lib/constants'
...
export const QueppelinProvider = ({ children }) => {
    ...
    const buyTokens = async () => {
      ...
      console.log(queppelinCoinAddress)
  
      let options = {
        contractAddress: queppelinCoinAddress,
        functionName: 'mint',
        abi: queppelinAbi,
        msgValue: calcPrice,
        params: {
